...
export const GROCERY_PLACEHOLDER_IMAGE_URL =
  'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&q=80&w=900';

const GROCERY_IMAGE_URLS_BY_PRODUCT_KEY: Record<string, string> = {
  bananas: 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438293/Bananas_jr3kjy.jpg',
  'honeycrisp-apples': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438291/Honeycrisp_Apples_ajcd8i.jpg',
  'navel-oranges': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438293/Navel_Oranges_pityki.jpg',
  strawberries: 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438294/Strawberries_woprop.jpg',
  'red-grapes': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438293/Red_Grapes_owi4tb.jpg',
  'baby-spinach': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438291/Baby_Spinach_aa4eg9.jpg',
  'iceberg-lettuce': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438292/Iceberg_Lettuce_wyj4qv.jpg',
  'romaine-hearts': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438293/Romaine_Hearts_ffj0qo.jpg',
  'roma-tomatoes': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438293/Roma_Tomatoes_bkurqk.jpg',
  avocados: 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438291/Avocados_rewupg.jpg',
  'ground-beef-8020': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438296/polatdover-ground-beef-6720584_u2ig0i.jpg',
  'chicken-breasts': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438295/pexels-alleksana-6107772_d0jur6.jpg',
  'classic-hot-dogs': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438296/pexels-fotios-photos-23833915_gaopdw.jpg',
  'turkey-breast-deli-meat': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438294/pexels-adonyi-foto-5491279_mkbpgr.jpg',
  'black-forest-ham': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438296/pexels-osmanarabaciart-26699180_fscazq.jpg',
  'sliced-lunch-meat': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438294/pexels-adonyi-foto-5491290_u9yvbl.jpg',
  'rotisserie-chicken': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438296/pexels-nano-erdozain-120534369-27643014_bkonre.jpg',
  'adobo-seasoning': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438279/Adobo_Seasoning_pu1axt.jpg',
  'italian-seasoning': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438284/Italian_Seasoning_sawmqb.jpg',
  'onion-powder': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438285/Onion_Powder_khnand.jpg',
  'garlic-herb-seasoning': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438283/Garlic_Herb_Seasoning_cn8pta.jpg',
  'lemon-pepper': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438289/Lemon_Pepper_rcadpz.jpg',
  'seasoning-blend': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438287/Seasoning_Blend_ce7xcb.jpg',
  ketchup: 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438284/Ketchup_hjk6kt.jpg',
  'yellow-mustard': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438287/Yellow_Mustard_dl5fh4.jpg',
  mayonnaise: 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438285/Mayonnaise_wntlxx.jpg',
  'chicken-noodle-soup': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438281/Chicken_Noodle_Soup_r0fw9x.jpg',
  'potato-soup': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438286/Potato_Soup_we6nal.jpg',
  'broccoli-cheddar-soup': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438280/Broccoli_Cheddar_Soup_oz8znk.jpg',
  'fruit-cereal': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438283/Fruit_Cereal_jhpfvb.jpg',
  'cinnamon-cereal': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438281/Cinnamon_Cereal_w1f9ks.jpg',
  'honey-nut-cereal': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438283/Honey_Nut_Cereal_t5qthn.jpg',
  'shredded-wheat': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438286/Shredded_Wheat_ktz6cl.jpg',
  'frosted-flakes': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438281/Frosted_Flakes_yzgjka.jpg',
  'honey-granola': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438285/Honey_Granola_q3yyru.jpg',
  'peanut-butter': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438286/Peanut_Butter_ps7rha.jpg',
  'round-crackers': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438297/pexels-obi-onyeador-1787470-13045014_p7xyvs.jpg',
  'saltine-crackers': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438298/pexels-frank-minjarez-333886454-36134940_nbtdbe.jpg',
  'tortilla-chips': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438296/pexels-davext-5855242_yukrgy.jpg',
  'potato-chips': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438296/pexels-caleboquendo-34466116_tearfe.jpg',
  'granola-bars': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438299/pexels-vovkapanda-6208145_knuobp.jpg',
  'chocolate-sandwich-cookies': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438297/pexels-madhu-sai-pavan-2148424047-30089166_wciuxk.jpg',
  'protein-snack-pack': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438299/pexels-vanessa-loring-5971972_ehxakv.jpg',
  'grape-jelly': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438283/Grape_Jelly_hotpfn.jpg',
  'strawberry-jam': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438288/Strawberry_Jam_mho3bi.jpg',
  'organic-snack-bars': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438290/Organic_Snack_Bars_orbhz0.jpg',
  'gluten-free-crackers': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438289/Gluten-Free_Crackers_jfanbt.jpg',
  'white-bread': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438490/White_Bread_xoe6up.jpg',
  'sandwich-bread': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438486/Sandwich_Bread_bhvh2l.jpg',
  'burger-buns': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438491/Burger_Buns_pflvm0.jpg',
  'white-rice': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438488/White_Rice_l4hcq5.jpg',
  'jasmine-rice': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438487/Jasmine_Rice_jhvonm.jpg',
  'instant-rice': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438484/Instant_Rice_nvvkp4.jpg',
  '21-whole-grains-bread': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438287/21_Whole_Grains_Bread_getffh.jpg',
  'whole-milk': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438485/pexels-alexasfotos-2198626_gvdg6d.jpg',
  'cheese-slices': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438489/pexels-jonathanborba-15754940_jkufxx.jpg',
  'shredded-cheese': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438487/pexels-klaus-nielsen-6287531_g8t7fq.jpg',
  'large-eggs': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438493/pexels-guerrero-de-la-luz-346901328-33128657_exlx0j.jpg',
  'lactose-free-milk': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438288/Lactose-Free_Milk_xcp07d.jpg',
  'dairy-free-cheese-shreds': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438290/Dairy-Free_Cheese_Shreds_kk80ob.jpg',
  'organic-whole-milk': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438290/Organic_Whole_Milk_q5ycx9.jpg',
  'pasture-raised-eggs': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438291/Pasture-Raised_Eggs_otnq5u.jpg',
  'ground-coffee': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438278/Ground_Coffee_t31wgo.jpg',
  'orange-juice': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438279/Orange_Juice_k06vci.jpg',
  'sports-drink-pack': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438280/Sports_Drink_Pack_y0sap6.jpg',
  'sparkling-water': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438279/Sparkling_Water_bmrkgj.jpg',
  'coffee-creamer': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438279/Coffee_Creamer_ocymbv.jpg',
  'organic-ground-coffee': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438290/Organic_Ground_Coffee_lchgxa.jpg',
  'almond-milk': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776438288/Almond_Milk_gf5ncv.jpg',
  'organic-strawberries': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776449398/Organic_Strawberries_ksaro7.jpg',
  'organic-romaine-hearts': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776449405/Organic_Romaine_Hearts_vwfaic.jpg',
  'organic-grapes': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776449395/Organic_Grapes_odwa6v.jpg',
  'organic-chicken-breasts': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776450222/Organic_Chicken_Breasts_mvtjlh.jpg',
  'nitrate-free-turkey': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776450159/Nitrate-free-turkey-AdobeStock_243184364_mpbyac.jpg',
  'organic-ketchup': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776449402/Organic_Ketchup_dzahtc.jpg',
  'avocado-oil-mayo': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776449421/Screenshot_2026-04-17_130727_ot2ish.png',
  'almond-butter': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776449409/Almond_Butter_u15k8s.jpg',
  'sunflower-seed-spread': 'https://res.cloudinary.com/dyjfdwah7/image/upload/v1776450288/Sunflower-seed-spread-AdobeStock_1954608802_mqv9bm.jpg',
};
