...
export default function App() {
  ...
  const activeRegions = useMemo(() => {
    const regionSource = USE_SUPABASE && safeRegions.length ? safeRegions : REGIONS;
  ...
  const activeSubscriptionOptions = getEnhancedSubscriptionOptions(USE_SUPABASE && safeSubscriptionOptions.length ? safeSubscriptionOptions : SUBSCRIPTION_OPTIONS);
  const activeClothingGameItems = USE_SUPABASE && safeClothingItems.length ? safeClothingItems : CLOTHING_GAME_ITEMS;
