...
export function ClothingGameStep({
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="-mx-2 bg-transparent px-2 py-0 shadow-none sm:mx-0 sm:rounded-3xl sm:border sm:border-slate-100 sm:bg-white sm:p-6 sm:shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-3">
            ...
            <div className="-mx-2 overflow-x-auto pb-1 sm:-mx-1 sm:overflow-visible">
              <div className="flex min-w-max gap-2 px-2 sm:flex-wrap sm:gap-3 sm:px-1">
        ...
        <div className="mt-4 divide-y divide-slate-200 rounded-[24px] bg-white sm:hidden">
          {activeItems.map((item) => {
            ...
            return (
              <div
                key={`${item.id}-mobile`}
                className={`bg-white px-2 py-3 transition-all first:rounded-t-[24px] last:rounded-b-[24px] ${
                  isInCloset
                    ? 'bg-emerald-50/20'
                    : ''
                }`}
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        <h5 className="text-[15px] font-black leading-tight text-slate-900">{item.name}</h5>
                        <p className="mt-0.5 line-clamp-2 text-[11px] font-medium leading-relaxed text-slate-500">{item.description}</p>
        ...
        <div className="mt-5 hidden grid-cols-1 gap-4 sm:mt-6 sm:grid sm:grid-cols-2 xl:grid-cols-3">
          {activeItems.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className={`relative flex h-full flex-col overflow-hidden rounded-3xl border-2 bg-white p-3 text-left transition-all sm:p-4 ${
                  isInCloset
              ...
              >
                ...
                <div className="flex flex-1 flex-col space-y-2">
                  ...
                  <div className="flex items-end justify-between gap-3 pt-2">
                    <div>
                      <p className="text-xl font-black text-[#3372B2] sm:text-2xl">${formatCurrency(item.price)}</p>
